{{--
    Upload modal — supports single, multiple, and drag-and-drop upload (the brief's
    "Single Upload / Multiple Upload / Drag & Drop Upload / Bulk Upload" requirements),
    all through the same StoreMediaRequest 'files[]' field. Dropzone.js is already
    loaded globally by admin.layouts.app, so no extra script include is needed here.
--}}
