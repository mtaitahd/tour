          ...
          <div class="card-body">
            ...
            <form method="POST" action="{{ route('admin.accommodations.store') }}">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <textarea name="amenities_raw" class="form-control" rows="4"
                            placeholder="One per line, e.g.&#10;Free WiFi&#10;Swimming Pool&#10;Spa & Wellness Centre">{{ old('amenities_raw') }}</textarea>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-5">
                  <input type="number" step="0.01" min="0" name="price_from" class="form-control" value="{{ old('price_from') }}">
                </div>
                <div class="col-sm-5">
                  <input type="text" name="currency" class="form-control" maxlength="3" value="{{ old('currency', 'USD') }}" placeholder="USD">
                </div>
              </div>
