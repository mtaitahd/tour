        ...
        <div class="card">
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mt-3 mb-3">
              ...
              <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#packageFormModal" onclick="openPackageForm('{{ route('admin.tour-packages.create') }}')">
    ...
    (function () {
      ...
      frame.addEventListener('load', function () {
        try {
          ...
          var basePath = new URL("{{ route('admin.tour-packages.index') }}", window.location.origin).pathname;
