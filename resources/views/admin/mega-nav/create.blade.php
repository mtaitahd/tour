...
@section('title', 'Add Mega Nav Item')

@section('content')
  <div class="pagetitle">
    <h1>Add Mega Nav Item</h1>
    <nav>
      <ol class="breadcrumb">
  ...
  <section class="section">
    <div class="row">
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">New Mega Nav Item</h5>
            ...
            <form method="POST" action="{{ route('admin.mega-nav.store') }}">
              @csrf
              ...
              <div class="row mb-3">
                <label class="col-sm-2 col-form-label"></label>
                <div class="col-sm-10">
                  <button type="submit" class="btn btn-primary">Add Mega Nav Item</button>
