...
@section('title', Setting::get('site_name', 'Afro-Vertex Tours & Safaris') . ' – Best Safaris, Climbs & Beach Tours in East Africa')

@section('extra-head')
    <meta name="description" content="{{ Setting::get('meta_description', 'Discover Tanzania safaris, Kilimanjaro climbs, Zanzibar beaches and gorilla trekking with Afro-Vertex Tours.') }}">
...
@section('page-content')
    ...
    <section class="afro-hero" id="afro-hero">
        <div class="afro-hero__bg">
            @if($heroImageUrl = Setting::imageUrl('hero_image_id'))
                <img src="{{ $heroImageUrl }}" alt="Safari landscape with elephants at golden hour" class="afro-hero__img">
            @else
                <img src="{{ asset('front-end/html/assets/img/avt-hero.webp') }}" alt="Safari landscape with elephants at golden hour" class="afro-hero__img">
            @endif
        </div>
        ...
        <div class="afro-hero__content">
            <div class="container">
                <div class="afro-hero__text wow fadeInUp" data-wow-delay="0.2s">
                    <h1 class="afro-hero__title">{{ Setting::get('hero_title', 'Discover the Wild Beauty of East Africa') }}</h1>
                    <p class="afro-hero__subtitle">{{ Setting::get('hero_subtitle', 'Handcrafted safaris, mountain climbs, and beach escapes — curated by local experts who know Africa best.') }}</p>
                </div>

                <div class="afro-search wow fadeInUp" data-wow-delay="0.4s">
                    <form class="afro-search__form" action="{{ route('tours.index') }}" method="get" role="search" aria-label="Safari search">
        ...
        <div class="afro-about__container">
            <div class="afro-about__grid">
                ...
                <div class="afro-about__content wow fadeInUp" data-wow-delay="0.2s">
                    <span class="afro-about__eyebrow">{{ Setting::get('home_about_eyebrow') ?: 'Our Story' }}</span>
                    <h2 class="afro-about__title">{!! Setting::get('home_about_title') ?: 'About Us &ndash; Afro-Vertex Tours &amp; Safaris' !!}</h2>
                    <p class="afro-about__text">{!! Setting::get('home_about_text') ?: 'Welcome to Afro-Vertex Africa Tanzania Safari LTD, where unforgettable African adventures meet the untamed beauty of nature. Based in Tanzania, we are a trusted safari operator and destination management company dedicated to creating immersive wildlife experiences, tailor-made journeys, mountain adventures, and relaxing beach escapes across East Africa.' !!}</p>
                    ...
                    <div class="afro-about__checklist">
                        <div class="afro-about__check-col">
                            ...
                            <div class="afro-about__check-item">
                                ...
                                <span class="afro-about__check-label">{{ $item }}</span>
                            </div>
                            @endforeach
                        </div>
                        <div class="afro-about__check-col">
                            @foreach($checklistB as $item)
                            <div class="afro-about__check-item">
                                <span class="afro-about__check-icon" aria-hidden="true">
                                    <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M11.6666 3.5L5.24992 9.91667L2.33325 7" stroke="#FFFFFF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                                </span>
                    ...
                    <a href="{{ Setting::get('home_about_btn_link') ?: route('page.show', 'about-us') }}" class="afro-about__btn">
    ...
    <section class="sae" id="sae" role="region" aria-label="Safari Atlas Explorer — Explore Africa's top safari countries">
        ...
        <div class="sae__inner">
            ...
            <nav class="sae__rail-wrap wow fadeInUp" data-wow-delay="0.15s" aria-label="Select a safari country">
                ...
                <div class="sae__rail" role="tablist" aria-label="Safari countries">
                    @foreach($saeCountries as $c)
                    <button
                        class="sae__marker {{ $loop->first ? 'sae__marker--active' : '' }}"
                        data-id="{{ $c['id'] }}"
                    ...
                    >
                        <span class="sae__marker-num">{{ str_pad($c['rank'], 2, '0', STR_PAD_LEFT) }}</span>
                        <span class="sae__marker-name">{{ $c['name'] }}</span>
                        <span class="sae__marker-rating">{{ number_format($c['rating'], 1) }}</span>
                    </button>
                    @endforeach
                </div>
            ...
            {{-- ── Expedition Canvas ──────────────────────────── --}}
            <div class="sae__canvas wow fadeInUp" data-wow-delay="0.25s" id="sae-panel" role="tabpanel" aria-labelledby="sae-tab-{{ $saeFirst['id'] }}">

                {{-- Visual storytelling area --}}
                <div class="sae__visual">
                    @foreach($saeCountries as $c)
                    <div class="sae__slide {{ $loop->first ? 'sae__slide--active' : '' }}" data-id="{{ $c['id'] }}" aria-hidden="{{ $loop->first ? 'false' : 'true' }}">
                        ...
                        <span class="sae__rank-hero" aria-hidden="true">{{ str_pad($c['rank'], 2, '0', STR_PAD_LEFT) }}</span>
                        <div class="sae__location-tag">
                            <span class="sae__location-continent">Africa</span>
                            <span class="sae__location-slash">/</span>
                            <span class="sae__location-country">{{ $c['name'] }}</span>
                            <span class="sae__location-tours">{{ $c['tourCount'] }} curated journeys</span>
                        </div>
                    </div>
                    @endforeach
                    ...
                    <div class="sae__seal" aria-hidden="true">
                        ...
                        <div class="sae__seal-inner">
                            <span class="sae__seal-rank" data-seal-rank>#{{ $saeFirst['rank'] }}</span>
                ...
                <div class="sae__info">
                    <div class="sae__info-inner">
                        ...
                        <h3 class="sae__country-name" data-sae-name>{{ $saeFirst['name'] }}</h3>

                        <div class="sae__rating">
                            <span class="sae__stars" aria-hidden="true">★★★★★</span>
                            <span class="sae__score" data-sae-score>{{ $saeFirst['rating'] }}</span>
                            <span class="sae__rating-label">Traveller Rating</span>
                        </div>

                        <p class="sae__rank-label" data-sae-rank-label>Ranked #{{ $saeFirst['rank'] }} of {{ $saeCount }} safari countries</p>

                        <p class="sae__desc" data-sae-desc>{{ $saeFirst['description'] }}</p>

                        <a class="sae__guide-link" data-sae-guide href="{{ $saeFirst['countryPageUrl'] }}">
                        ...
                        <div class="sae__notes">
                            <div class="sae__note">
                                ...
                                <div class="sae__note-body">
                                    ...
                                    <span class="sae__note-value" data-sae-price>{{ $saeFirst['priceRange'] }}</span>
                                </div>
                            </div>
                            <div class="sae__note">
                                ...
                                <div class="sae__note-body">
                                    ...
                                    <span class="sae__note-value" data-sae-best>{{ $saeFirst['bestTime'] }}</span>
                                </div>
                            </div>
                            <div class="sae__note">
                                ...
                                <div class="sae__note-body">
                                    ...
                                    <span class="sae__note-value" data-sae-season>{{ $saeFirst['highSeason'] }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="sae__actions">
                            <a class="sae__btn sae__btn--primary" data-sae-primary href="{{ $saeFirst['safariPageUrl'] }}">
                                <span data-sae-primary-text>Explore {{ $saeFirst['name'] }} Safaris</span>
                            ...
                            <a class="sae__btn sae__btn--secondary" data-sae-secondary href="{{ $saeFirst['countryPageUrl'] }}">
            ...
            <div class="sae__route wow fadeInUp" data-wow-delay="0.35s" aria-label="Key destinations">
                <div class="sae__route-inner">
                    @foreach($saeFirst['destinations'] as $i => $dest)
                    <div class="sae__route-stop">
                        <span class="sae__route-dot"></span>
                        <span class="sae__route-name">{{ $dest['name'] }}</span>
                        <span class="sae__route-cat">{{ $dest['cat'] }}</span>
                    </div>
                    @if(!$loop->last)
        ...
        {{-- Country data JSON --}}
        <script id="sae-data" type="application/json">{!! json_encode($saeCountries) !!}</script>
            ...
            <div class="featured-tours-grid">
                @forelse($featuredDestinations as $dest)
                    ...
                    <article class="afro-tour-card afro-tour-card--refined">
                        <a href="{{ route('destination.show', $dest->slug) }}" class="afro-tour-card__img-link" aria-label="{{ $dest->name }}">
                            <div class="afro-tour-card__img-wrap">
                                <img src="{{ $destImage }}" alt="{{ $dest->name }}" class="afro-tour-card__img" width="800" height="600" loading="lazy"
                                ...
                                <span class="afro-tour-card__badge">{{ $destToursCount }} {{ Str::plural('Tour', $destToursCount) }}</span>
                                <h3 class="afro-tour-card__title">{{ $dest->name }}</h3>
                            </div>
                        </a>
                        ...
                        <div class="afro-tour-card__body">
                            ...
                            @if($dest->description)
                                <p class="afro-tour-card__desc">{{ Str::limit(strip_tags($dest->description), 120) }}</p>
                            @endif

                            <div class="afro-tour-card__meta">
                                <span class="afro-tour-card__meta-item">
                                    <i class="isax isax-location5" aria-hidden="true"></i>
                                    {{ $dest->country_code ? strtoupper($dest->country_code) : 'East Africa' }}
                                    @if($dest->type)
                                        · {{ ucfirst(str_replace('_', ' ', $dest->type)) }}
                                    @endif
                                </span>
                            </div>

                            <a href="{{ route('destination.show', $dest->slug) }}" class="afro-tour-card__more">
                                View Destination
    ...
    <section class="section ft-section">
        <div class="featured-tours-container">
            ...
            <div class="featured-tours-grid">
                @forelse($featuredTours as $SingleTour)
                    @php
                    ...
                    @endphp
                    <article class="afro-tour-card afro-tour-card--refined">
                        <a href="{{ route('tour.show', $SingleTour->slug) }}" class="afro-tour-card__img-link" aria-label="{{ $SingleTour->cardTitle() }}">
                            <div class="afro-tour-card__img-wrap">
                                <img src="{{ $SingleTour->cardImageUrl('medium') }}" alt="{{ $SingleTour->cardTitle() }}" class="afro-tour-card__img" width="800" height="600" loading="{{ $loop->index < 3 ? 'eager' : 'lazy' }}"
                                     onerror="this.onerror=null;this.src='{{ asset('public/assets/images/safari-hero.jpg') }}';">
                                <div class="afro-tour-card__overlay" aria-hidden="true"></div>
                                <h3 class="afro-tour-card__title">{{ $SingleTour->cardTitle() }}</h3>
                            </div>
                        </a>

                        <button type="button"
                                class="av-fav-btn"
                                data-tour-id="{{ $SingleTour->id }}"
                                data-tour-title="{{ $SingleTour->cardTitle() }}"
                                aria-pressed="false"
                                aria-label="Add {{ $SingleTour->cardTitle() }} to favourites">
                            <i class="ti ti-heart" aria-hidden="true"></i>
                        </button>

                        <div class="afro-tour-card__body">

                            @if($SingleTour->overview)
                                <p class="afro-tour-card__desc">{{ Str::limit(strip_tags($SingleTour->overview), 120) }}</p>
                            @endif

                            <div class="afro-tour-card__price-row">
                                <div class="afro-tour-card__price">
                                    @php $cardFrom = $fromPrices[$SingleTour->id] ?? null; @endphp
                                    @if($cardFrom)
                                        <span class="afro-tour-card__price-label">From</span>
                                        <span class="afro-tour-card__price-amount">${{ number_format($cardFrom['amount'], 0) }}</span>
                            ...
                            @if($visitLine)
                                <p class="afro-tour-card__desc">
                                    <strong>You Visit:</strong> {!! str_replace(' (End)', ' <span class="text-muted">(End)</span>', e($visitLine)) !!}
                                </p>
                            @endif

                            <a href="{{ route('tour.show', $SingleTour->slug) }}" class="afro-tour-card__more">
                                View Tour
                                <svg width="16" height="16" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M4.16663 10H15.8333M15.8333 10L10.4166 4.58334M15.8333 10L10.4166 15.4167"/></svg>
                            </a>
                        </div>
                        ...
                        <footer class="afro-tour-card__foot">
                            ...
                            <div class="afro-tour-card__foot-info">
                                ...
                                <span>
                                    ...
                                    {{ number_format($avgOperatorRating, 1) }}/5 – {{ $operatorReviews }} Review{{ Str::plural('s', $operatorReviews) }}
                                </span>
                            </div>
                        </footer>
                    </article>
                @empty
                    <div class="afro-tour-grid__empty">
                        ...
                        <a href="{{ route('tours.index') }}" class="afro-tour-card__cta afro-tour-card__cta--inline">View All Tours</a>
                    </div>
                @endforelse
            </div>
    ...
    <section class="wwgt" id="worldwide-group-travellers" aria-labelledby="wwgt-heading">
        <div class="container wwgt__container">
            ...
            <div class="wwgt__grid wwgt__grid--more" id="wwgt-grid" role="list" aria-label="Countries">
                @foreach ($wwgtFeatured as $wwgtC)
                    @include('frontend.partials.country-card', ['wwgtC' => $wwgtC, 'wwgtFeaturedFlag' => true])
                @endforeach

                @foreach ($wwgtMore as $wwgtC)
                    @include('frontend.partials.country-card', ['wwgtC' => $wwgtC, 'wwgtFeaturedFlag' => false])
                @endforeach
            </div>
            ...
            <div class="container">
                ...
                <div class="flip-cards">
                    @foreach($whyChooseUsCards as $card)
                        ...
                        <div class="flip-card" tabindex="0" role="button" aria-expanded="false" aria-label="{{ $card['title'] ?? '' }}">
                            <div class="flip-card-inner">
                                <div class="flip-card-front">
                                    <span class="flip-card__num" aria-hidden="true">{{ $num }}</span>
                                    @if(!empty($card['icon']))
                                        <span class="flip-card__icon" aria-hidden="true"><i class="{{ $card['icon'] }}"></i></span>
                                    @endif
                                ...
                                <div class="flip-card-back">
                                    ...
                                    @if(!empty($card['description']))
                                        <p class="flip-card-back__text">{{ $card['description'] }}</p>
                                    @endif
                                    <a class="flip-card-back__link" href="{{ Route::has('about') ? route('about') : '#' }}">Learn More</a>
                                </div>
                            </div>
                        </div>
                    @endforeach
    ...
    <section class="latest-blog-section">
        <div class="latest-blog-container">
            ...
            <div class="latest-blog-grid">
                @forelse($latestPosts as $BlogPost)
                    <article class="blog-card">
                        <a href="{{ route('blog.show', $BlogPost->slug) }}" class="blog-card-link" aria-label="{{ $BlogPost->cardTitle() }}">
                            <img src="{{ $BlogPost->cardImageUrl('medium') }}"
                                 alt="{{ $BlogPost->cardTitle() }}"
                                 width="800" height="600"
                                 loading="lazy"
                                 onerror="this.onerror=null;this.src='{{ asset('public/assets/images/kilimanjaro-hero-2.jpg') }}';">
                            <h3 class="blog-card-title">{{ $BlogPost->cardTitle() }}</h3>
                        </a>
                    </article>
                @empty
    ...
    <section class="scw" id="explore-gallery" role="region" aria-label="Safari Cinema Wall — Image gallery">
        ...
        <div class="scw__inner">
            ...
            <div class="scw__filters" role="tablist" aria-label="Filter gallery by category">
                @foreach($scwCategories as $fi => $fc)
                    <button
                        type="button"
                        class="scw__filter-btn {{ $fi === 0 ? 'scw__filter-btn--active' : '' }}"
                        data-scw-cat="{{ strtolower($fc) }}"
                        role="tab"
            ...
            <div class="scw__wall wow fadeInUp" data-wow-delay="0.2s">
                ...
                <div class="scw__reel" role="tablist" aria-label="Gallery frames">
                    @foreach($scwImages as $i => $img)
                        @if($i < 3)
                        <button
                            class="scw__reel-frame {{ $i === 0 ? 'scw__reel-frame--active' : '' }}"
                            data-scw-idx="{{ $i }}"
                            data-scw-cat="{{ strtolower($img['category'] ?? 'wildlife') }}"
                            role="tab"
                            aria-selected="{{ $i === 0 ? 'true' : 'false' }}"
                            aria-label="View frame {{ str_pad($i + 1, 2, '0', STR_PAD_LEFT) }}: {{ $img['alt'] }}"
                        >
                            <span class="scw__reel-num">{{ str_pad($i + 1, 2, '0', STR_PAD_LEFT) }}</span>
                ...
                {{-- Centre: Main Cinematic Image --}}
                <div class="scw__stage">
                    @foreach($scwImages as $i => $img)
                    <div
                        class="scw__frame {{ $i === 0 ? 'scw__frame--active' : '' }}"
                        data-scw-idx="{{ $i }}"
                        data-scw-cat="{{ strtolower($img['category'] ?? 'wildlife') }}"
                    ...
                    >
                        ...
                        <div class="scw__frame-caption">
                            <span class="scw__frame-cat">{{ $img['country'] }} / {{ $img['destination'] }}</span>
                            <span class="scw__frame-title">{{ $img['destination'] }}</span>
                            @if($img['caption'])
                                <span class="scw__frame-desc">{{ \Illuminate\Support\Str::limit($img['caption'], 80) }}</span>
                            @endif
                        </div>
                    </div>
                    @endforeach
                ...
                <div class="scw__panel">
                    <div class="scw__panel-inner">
                        ...
                        <p class="scw__panel-statement" data-scw-statement>{{ $scwFirst['destination'] }}</p>

                        @if($scwFirst['caption'])
                            <p class="scw__panel-caption" data-scw-caption>{{ \Illuminate\Support\Str::limit($scwFirst['caption'], 100) }}</p>
                        @else
                        ...
                        <div class="scw__panel-meta">
                            <div class="scw__panel-meta-row">
                                ...
                                <span data-scw-location>{{ $scwFirst['destination'] }}</span>
                            </div>
                        </div>
                        ...
                        <div class="scw__previews" data-scw-previews>
                            @foreach($scwImages as $i => $img)
                                ...
                                <button
                                    type="button"
                                    class="scw__preview {{ $i === 1 ? 'scw__preview--active' : '' }}"
                                    data-scw-idx="{{ $i }}"
                                    aria-label="View frame {{ str_pad($i + 1, 2, '0', STR_PAD_LEFT) }}: {{ $img['alt'] }}"
                                >
                                    <span class="scw__preview-num">{{ str_pad($i + 1, 2, '0', STR_PAD_LEFT) }}</span>
                                    ...
                                    <span class="scw__preview-title">{{ $img['destination'] }}</span>
                                </button>
                                @endif
                            @endforeach
                        </div>

                        {{-- View All circular control --}}
                        <div class="scw__viewall-wrap">
                            <button
                                type="button"
                                class="scw__viewall"
                                data-scw-viewall
                                aria-label="View all {{ $scwCount }} photos in lightbox"
                            >
                                <span class="scw__viewall-text">View<br><strong>{{ $scwCount }}</strong></span>
            ...
            <div class="scw__timeline wow fadeInUp" data-wow-delay="0.3s">
                ...
                <div class="scw__tl-track">
                    ...
                    @foreach($scwImages as $i => $img)
                        ...
                        <button
                            type="button"
                            class="scw__tl-tick {{ $i === 0 ? 'scw__tl-tick--active' : '' }}"
                            data-scw-idx="{{ $i }}"
                            data-scw-cat="{{ strtolower($img['category'] ?? 'wildlife') }}"
                            aria-label="Frame {{ str_pad($i + 1, 2, '0', STR_PAD_LEFT) }}: {{ $img['destination'] }}"
                        >
                            <span class="scw__tl-dot"></span>
                            <span class="scw__tl-cat">{{ $img['destination'] }}</span>
                        </button>
                        @endif
                    @endforeach
                </div>
        ...
        {{-- Gallery data JSON --}}
        <script id="scw-data" type="application/json">{!! json_encode($scwImages) !!}</script>
                ...
                <div class="owl-carousel testi-carousel">
                    @forelse($testimonials as $testimonial)
                        <div class="testi-card">
                            ...
                            <a href="{{ route('page.show', 'contact') }}" class="testi-card__more">Read More</a>
                            <div class="testi-card__person">
                                ...
                                <div>
                                    <h6 class="testi-card__name mb-0">{{ $testimonial->name }}</h6>
                                    @if($testimonial->location)
                                        <span class="testi-card__loc d-block text-muted">{{ $testimonial->location }}</span>
                                    @endif
                                </div>
                            </div>
                        </div>
    ...
    <section class="plan-cta" aria-labelledby="planCtaHeading">
        ...
        <div class="plan-cta__media">
            <img src="{{ $ctaImage }}" alt="Friendly Afro-Vertex local safari guide beside an open safari vehicle on the golden-hour savannah" class="plan-cta__img" width="900" height="1100" loading="lazy">
        </div>
        ...
        <div class="plan-cta__panel">
            ...
            <div class="plan-cta__content">
                ...
                <h2 class="plan-cta__title" id="planCtaHeading">{{ $ctaTitle }}</h2>
                <p class="plan-cta__desc">{{ $ctaSubtitle }}</p>
                <div class="plan-cta__actions">
                    <a href="{{ $primaryLink }}" class="plan-cta__btn plan-cta__btn--primary">{{ $primaryText }}</a>
                    <a href="{{ $waLink }}" target="_blank" rel="noopener" class="plan-cta__btn plan-cta__btn--wa">
    ...
    {{-- <div class="client-logos-sec">
        <div class="container">
            <div>
                <h6 class="text-white mb-3">Trusted by Travelers Worldwide</h6>
            </div>
            <div class="owl-carousel client-slider">
                <div class="client-img">
                    <img src="{{ asset('front-end/html/assets/img/clients/client-01.svg') }}" class="img-white" alt="Client">
                </div>
                <div class="client-img">
                    <img src="{{ asset('front-end/html/assets/img/clients/client-02.svg') }}" class="img-white" alt="Client">
                </div>
                <div class="client-img">
                    <img src="{{ asset('front-end/html/assets/img/clients/client-03.svg') }}" class="img-white" alt="Client">
                </div>
                <div class="client-img">
                    <img src="{{ asset('front-end/html/assets/img/clients/client-04.svg') }}" class="img-white" alt="Client">
                </div>
                <div class="client-img">
                    <img src="{{ asset('front-end/html/assets/img/clients/client-05.svg') }}" class="img-white" alt="Client">
                </div>
            </div>
        </div>
    </div> --}}
        ...
        <section class="tours-faq-section">
            <div class="sfb-container">
                @include('frontend.partials.faq-section', ['faqSubject' => 'African'])
            </div>
        </section>
...
@section('extra-scripts')
    @include('frontend.partials.faq-script')
    {{-- Rendered at body level (via extra-scripts yield) so the hero's
         overflow:hidden can never clip either popover. --}}
    ...
    (function () {
        ...
        @endphp
        var DESTINATIONS = @json($destSearchData);
