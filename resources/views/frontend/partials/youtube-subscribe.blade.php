    ...
    <div class="av-yt__container">
        ...
        <div class="av-yt__grid">
            @foreach($ytVideos as $video)
                <a class="av-yt-card" href="{{ $video['url'] }}" target="_blank" rel="noopener noreferrer">
                    ...
                    <span class="av-yt-card__title">{{ $video['title'] }}</span>
                    <span class="av-yt-card__meta">{{ $video['views'] }}, {{ $video['when'] }}</span>
                </a>
            @endforeach
        </div>

        {{-- Subscribe button --}}
        <a class="av-yt__btn" href="{{ $ytSubUrl ?? $ytChannel }}" target="_blank" rel="noopener noreferrer">
