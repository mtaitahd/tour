...
(function () {
  ...
  // Fligt Check (legacy - kept for compatibility)
  ...
  // Car Check (legacy - kept for compatibility)
  if ($(".banner-form").length > 0) {
    $(".banner-form .form-check-input").on("change", function (e) {
      var radioval = $(this).val();
  ...
  // Safari Search Date Picker
  if ($(".afro-search__input--date").length > 0) {
    $(".afro-search__input--date").datetimepicker({
      format: "DD-MM-YYYY",
      minDate: new Date(),
      icons: {
        up: "fas fa-angle-up",
