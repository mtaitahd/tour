...
unset($__errorArgs, $__bag); ?>"
                   value="<?php echo e(old('email')); ?>" placeholder="Enter your email or username" required autofocus autocomplete="email">
          </div>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="login-row">
          ...
          <?php if(Route::has('password.request')): ?>
            <a class="login-forgot" href="<?php echo e(route('password.request')); ?>">Forgot password?</a>
          <?php endif; ?>
        </div>
...
<?php echo $__env->make('admin.layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tour\resources\views\auth\login.blade.php ENDPATH**/ ?>