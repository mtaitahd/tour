...
<div class="modal fade media-picker-modal" id="picker-<?php echo e($pickerId); ?>" tabindex="-1" data-multiple="<?php echo e($multiple ? '1' : '0'); ?>">
  <div class="modal-dialog modal-xl modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Select <?php echo e($multiple ? 'Images' : 'an Image'); ?></h5>
...
<?php if (! $__env->hasRenderedOnce('1408e3de-f378-475c-a8c1-44df280c184e')): $__env->markAsRenderedOnce('1408e3de-f378-475c-a8c1-44df280c184e'); ?>
...
document.addEventListener('DOMContentLoaded', function () {
    document.querySelectorAll('.media-picker-modal').forEach(function (modalEl) {
        ...
        function search(page = 1) {
            ...
            fetch(`<?php echo e(route('admin.media.picker.search')); ?>?${params.toString()}`, {
...
<?php $__env->stopPush(); ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\tour\resources\views\admin\media\partials\modal-picker.blade.php ENDPATH**/ ?>