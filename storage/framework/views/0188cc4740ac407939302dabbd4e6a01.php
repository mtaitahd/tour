  ...
  <section class="section">
    <div class="row">
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">New Accommodation</h5>
            ...
            <form method="POST" action="<?php echo e(route('admin.accommodations.store')); ?>">
              <?php echo csrf_field(); ?>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="text" name="tier" class="form-control" value="<?php echo e(old('tier')); ?>"
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  ...
                  <small class="text-muted">Optional — links this accommodation to one of your destination pages.</small>
                </div>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  ...
                  <small class="text-muted">Free-text location, used alongside or instead of a Destination link.</small>
                </div>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <textarea name="description" class="form-control tinymce-editor" rows="8"><?php echo e(old('description')); ?></textarea>
                </div>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <textarea name="amenities_raw" class="form-control" rows="4"
                            placeholder="One per line, e.g.&#10;Free WiFi&#10;Swimming Pool&#10;Spa & Wellness Centre"><?php echo e(old('amenities_raw')); ?></textarea>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-5">
                  <input type="number" step="0.01" min="0" name="price_from" class="form-control" value="<?php echo e(old('price_from')); ?>">
                </div>
                <div class="col-sm-5">
                  <input type="text" name="currency" class="form-control" maxlength="3" value="<?php echo e(old('currency', 'USD')); ?>" placeholder="USD">
                </div>
              </div>
...
<?php endif; ?>
                  ...
                  <div class="col-md-6">
                      ...
                      <?php if (isset($component)) { $__componentOriginala26ee479c72899be3529000ab55d5999 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala26ee479c72899be3529000ab55d5999 = $attributes; } ?>
<?php $component = App\View\Components\MediaPicker::resolve(['name' => 'gallery_image_ids','multiple' => true,'selected' => old('gallery_image_ids', []),'label' => 'Select Gallery Images'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('media-picker'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\MediaPicker::class))->getConstructor()): ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tour\resources\views\admin\accommodations\create.blade.php ENDPATH**/ ?>