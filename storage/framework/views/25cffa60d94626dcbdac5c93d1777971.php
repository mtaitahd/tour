  ...
  <div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Edit: <?php echo e(Str::limit($testimonial->name, 30)); ?></li>
      </ol>
    </nav>
  </div>
  ...
  <section class="section">
    <div class="row">
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Edit: <?php echo e($testimonial->name); ?></h5>
            ...
            <form method="POST" action="<?php echo e(route('admin.testimonials.update', $testimonial)); ?>">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="text" name="name" class="form-control" value="<?php echo e(old('name', $testimonial->name)); ?>" required>
                </div>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="text" name="location" class="form-control" value="<?php echo e(old('location', $testimonial->location)); ?>" placeholder="e.g. United Kingdom">
                </div>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <select name="rating" class="form-select w-auto" required>
                    <?php for($i = 5; $i >= 1; $i--): ?>
                      <option value="<?php echo e($i); ?>" <?php echo e(old('rating', $testimonial->rating) == $i ? 'selected' : ''); ?>><?php echo e($i); ?> Star<?php echo e($i > 1 ? 's' : ''); ?></option>
                    <?php endfor; ?>
                  </select>
                </div>
              </div>
...
<?php $component = App\View\Components\MediaPicker::resolve(['name' => 'avatar_image_id','selected' => old('avatar_image_id', $testimonial->avatar_image_id),'label' => 'Select from Media Library'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                ...
                <div class="col-sm-10">
                  <select name="tour_package_id" class="form-select">
                    ...
                    <?php $__currentLoopData = $tourPackages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tour): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option value="<?php echo e($tour->id); ?>" <?php echo e(old('tour_package_id', $testimonial->tour_package_id) == $tour->id ? 'selected' : ''); ?>>
                ...
                <div class="col-sm-10">
                  <select name="destination_id" class="form-select">
                    ...
                    <?php $__currentLoopData = $destinations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $destination): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option value="<?php echo e($destination->id); ?>" <?php echo e(old('destination_id', $testimonial->destination_id) == $destination->id ? 'selected' : ''); ?>>
              ...
              <div class="row mb-3 mt-5">
                ...
                <div class="col-sm-10">
                  <select name="status" class="form-select" required>
                    <option value="draft" <?php echo e(old('status', $testimonial->status) == 'draft' ? 'selected' : ''); ?>>Draft</option>
                    <option value="published" <?php echo e(old('status', $testimonial->status) == 'published' ? 'selected' : ''); ?>>Published</option>
                    <option value="archived" <?php echo e(old('status', $testimonial->status) == 'archived' ? 'selected' : ''); ?>>Archived</option>
                  </select>
                </div>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="is_featured" value="1" <?php echo e(old('is_featured', $testimonial->is_featured) ? 'checked' : ''); ?>>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="number" name="order" class="form-control w-25" value="<?php echo e(old('order', $testimonial->order)); ?>">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tour\resources\views\admin\testimonials\edit.blade.php ENDPATH**/ ?>