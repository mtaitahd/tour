...
} elseif ($_instance->childHasBeenRendered('zuEeolF')) {
    $componentId = $_instance->getRenderedChildComponentId('zuEeolF');
    $componentTag = $_instance->getRenderedChildComponentTagName('zuEeolF');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('zuEeolF');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('zuEeolF', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\tour\vendor\filament\filament\resources\views\components\layouts\card.blade.php ENDPATH**/ ?>