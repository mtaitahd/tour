<!DOCTYPE html>
<html lang="en">
<?php $modalView = request()->boolean('modal'); ?>
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
<meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">
<title><?php echo $__env->yieldContent('title', 'Admin Dashboard'); ?> - Afro Vertex Tours</title>
...
<script src="<?php echo e(asset('assets/js/tinymce/tinymce.min.js')); ?>?v=6"></script>
...
<body id="page-top" class="<?php echo e($modalView ? 'modal-view' : ''); ?>">
...
<div id="wrapper">
  ...
  <div id="content-wrapper" class="d-flex flex-column">
    <div id="content">
      ...
      <!-- Page Content -->
      <div class="container-fluid <?php echo e($modalView ? 'px-3 py-3' : ''); ?>" id="container-wrapper">
...
<?php /**PATH C:\xampp\htdocs\tour\resources\views\admin\layouts\app.blade.php ENDPATH**/ ?>