        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center mt-3 mb-3">
              ...
              <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#pageFormModal" onclick="openPageForm('<?php echo e(route('admin.pages.create')); ?>')">
              ...
              <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                  <tr>
                    ...
                    <td>
                      <a href="<?php echo e(route('page.show', $page->slug)); ?>" target="_blank" class="btn btn-info btn-sm" title="View on site">
                        <i class="bi bi-eye"></i>
                      </a>
                      <button type="button" class="btn btn-sm btn-outline-primary" title="Edit"
                              data-bs-toggle="modal" data-bs-target="#pageFormModal"
                              onclick="openPageForm('<?php echo e(route('admin.pages.edit', $page->id)); ?>')">
                      ...
                      <form action="<?php echo e(route('admin.pages.destroy', $page->id)); ?>" method="POST" class="d-inline">
                          ...
                          <button type="button" class="btn btn-sm btn-outline-danger" 
                                  ...
                                  data-bs-target="#deleteModal<?php echo e($page->id); ?>"
                                  title="Delete">
                              <i class="fas fa-trash"></i>
                          </button>

                          <!-- Modal for this specific page -->
                          <div class="modal fade" id="deleteModal<?php echo e($page->id); ?>" tabindex="-1" aria-labelledby="deleteModalLabel<?php echo e($page->id); ?>" aria-hidden="true">
                              <div class="modal-dialog modal-dialog-centered">
                                  <div class="modal-content">
                                      <div class="modal-header bg-danger text-white">
                                          <h5 class="modal-title" id="deleteModalLabel<?php echo e($page->id); ?>">Confirm Deletion</h5>
                                          <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                                      </div>
                                      <div class="modal-body">
                                          Are you sure you want to delete the page:  
                                          <strong>"<?php echo e($page->title); ?>"</strong>?<br>
    ...
    (function () {
      ...
      frame.addEventListener('load', function () {
        try {
          ...
          var basePath = new URL("<?php echo e(route('admin.pages.index')); ?>", window.location.origin).pathname;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tour\resources\views\admin\pages\index.blade.php ENDPATH**/ ?>