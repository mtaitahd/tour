...
} elseif ($_instance->childHasBeenRendered('hAqBLfy')) {
    $componentId = $_instance->getRenderedChildComponentId('hAqBLfy');
    $componentTag = $_instance->getRenderedChildComponentTagName('hAqBLfy');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('hAqBLfy');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('hAqBLfy', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('av2Kv5b')) {
    $componentId = $_instance->getRenderedChildComponentId('av2Kv5b');
    $componentTag = $_instance->getRenderedChildComponentTagName('av2Kv5b');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('av2Kv5b');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('av2Kv5b', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\xampp\htdocs\tour\vendor\filament\filament\resources\views\components\topbar.blade.php ENDPATH**/ ?>