    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-10">
            <input type="text" name="manual_currency" id="pricing-manual-currency"
                   ...
                   value="<?php echo e($currentManualCurrency); ?>" autocomplete="off">
...
</div><?php /**PATH C:\xampp\htdocs\tour\resources\views\admin\tour-packages\partials\pricing\manual.blade.php ENDPATH**/ ?>