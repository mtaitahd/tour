...
<?php $__env->startSection('title', ($post->meta_title ?? $displayTitle) . ' | Afro-Vertex Tours Blog'); ?>

<?php $__env->startSection('extra-head'); ?>
    <meta name="description" content="<?php echo e($post->meta_description ?? Str::limit(strip_tags($displayContent), 160)); ?>">
    ...
    <meta property="og:description" content="<?php echo e(Str::limit(strip_tags($displayContent), 200)); ?>">
    ...
    <script type="text/javascript">
        function googleTranslateElementInit() {
            new google.translate.TranslateElement({
                pageLanguage: 'en',
                autoDisplay: false,
                includedLanguages: '<?php echo e($languageCode); ?>'
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-12">
                <h1 class="breadcrumb-title mb-2"><?php echo e($displayTitle); ?></h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center mb-0">
                        <li class="breadcrumb-item"><a href="<?php echo e(route('home')); ?>"><i class="isax isax-home5"></i></a></li>
                        <li class="breadcrumb-item"><a href="<?php echo e(route('blog.index')); ?>"><?php echo e($translated['blog']); ?></a></li>
                        <li class="breadcrumb-item active"><?php echo e(Str::limit($displayTitle, 40)); ?></li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="row">
                        ...
                        <div class="blog-content">
                            ...
                            <?php if($post->hasFeaturedImage()): ?>
                                <div class="blog-image mb-3">
                                    <img src="<?php echo e($post->featuredImageUrl()); ?>"
                                         alt="<?php echo e($displayTitle); ?>" class="img-fluid rounded">
                                </div>
                            <?php endif; ?>
                            ...
                            <div class="d-flex align-items-center flex-wrap row-gap-2 mb-3">
                                <a href="javascript:void(0);" class="d-flex align-items-center fs-16 text-gray-9 pe-3 border-end me-3">
                                    ...
                                    <?php echo e(Auth::user()->name ?? $translated['admin']); ?>

                                </a>
                                <div class="pe-3 border-end me-3">
                                    <span class="d-flex align-items-center fs-16 text-gray-9">
                                        <i class="isax isax-calendar-2 me-1"></i>
                                        <?php echo e($post->published_at ? $post->published_at->format('d M Y') : $translated['draft']); ?>

                                    </span>
                                </div>
                                <?php if($post->category): ?>
                                    <span class="badge badge-sm badge-primary"><?php echo e($translated['category_name'] ?? $post->category->name); ?></span>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="mt-3 pb-3 border-bottom d-flex flex-wrap align-items-center justify-content-between">
                                <div class="d-flex align-items-center">
                                    <p class="fs-16 text-gray-9 mb-0 me-2"><?php echo e($translated['tags']); ?></p>
                                    <a href="#" class="badge badge-sm badge-secondary me-2"><?php echo e($translated['travels']); ?></a>
                                    <a href="#" class="badge badge-sm badge-secondary me-2"><?php echo e($translated['tips']); ?></a>
                                    <a href="#" class="badge badge-sm badge-secondary"><?php echo e($translated['guide']); ?></a>
                                </div>
                                <div class="d-flex align-items-center">
                                    <p class="fs-16 text-gray-9 mb-0 me-2"><?php echo e($translated['share']); ?></p>
                                    ...
                                    <a href="https://twitter.com/intent/tweet?url=<?php echo e(urlencode(request()->url())); ?>&text=<?php echo e(urlencode($displayTitle)); ?>" target="_blank" class="me-2">
                                        <img src="<?php echo e(asset('front-end/html/assets/img/icons/twitter.svg')); ?>" alt="Twitter">
                                    </a>
                                    <a href="https://wa.me/?text=<?php echo e(urlencode($displayTitle . ' ' . request()->url())); ?>" target="_blank">
                            ...
                            <div class="my-3">
                                <div class="border border-light br-10 p-3 d-md-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <h6 class="fs-14 text-primary mb-1"><?php echo e($translated['about_author']); ?></h6>
                                        <p class="fs-16 text-gray-6"><?php echo e($translated['author_bio']); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-lg-4 col-md-12 theiaStickySidebar">
                    ...
                    <div class="card-body">
                        <div class="pb-3 border-bottom mb-3">
                            <h5 class="d-flex align-items-center">
                                <span class="me-1 fs-16"><i class="isax isax-search-normal text-primary"></i></span> <?php echo e($translated['search']); ?>
                ...
                <div class="card mb-3">
                    <div class="card-header border-0 pb-0">
                        <div class="pb-3 border-bottom">
                            <h5><i class="isax isax-candle text-primary fs-16 me-2"></i><?php echo e($translated['categories']); ?></h5>
                        </div>
                    </div>
                ...
                <div class="card mb-3">
                    <div class="card-header border-0 pb-0">
                        <div class="pb-3 border-bottom">
                            <h5><i class="ti ti-brand-blogger text-primary fs-16 me-2"></i><?php echo e($translated['related_posts']); ?></h5>
                        </div>
                    </div>
                    <div class="card-body pt-3">
                        <?php $__currentLoopData = $relatedPosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $related): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div>
                                        <a href="<?php echo e(route('blog.show', $related->slug)); ?>"
                                           class="two-line-ellipsis fs-14 fw-medium">
                                            <?php echo e($translated['related_title_' . $index] ?? $related->title); ?>
                                        ...
                                        <div class="d-flex align-items-center mt-2">
                                            <a href="#" class="d-flex align-items-center border-end pe-2 me-2">
                                                ...
                                                <p class="fs-14 text-truncate"><?php echo e($translated['admin']); ?></p>
                                            </a>
                                            <p class="fs-14 text-truncate">
                                                <i class="isax isax-calendar-2 me-2"></i>
                                                <?php echo e($related->published_at ? $related->published_at->format('d M Y') : $translated['draft']); ?>
                ...
                <div class="card mb-0">
                    <div class="card-header border-0 pb-0">
                        <div class="pb-3 border-bottom">
                            <h5><i class="isax isax-tag text-primary fs-16 me-2"></i><?php echo e($translated['popular_tags']); ?></h5>
                        </div>
                    </div>
                    <div class="card-body pt-3 pb-2">
                        <div class="d-flex align-items-center flex-wrap category-tag">
                            <a href="#" class="badge badge-md fw-normal me-2 mb-2"><?php echo e($translated['luxury']); ?></a>
                            <a href="#" class="badge badge-md fw-normal me-2 mb-2"><?php echo e($translated['travel']); ?></a>
                            <a href="#" class="badge badge-md fw-normal me-2 mb-2"><?php echo e($translated['nature']); ?></a>
                            <a href="#" class="badge badge-md fw-normal mb-2"><?php echo e($translated['photography']); ?></a>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        const targetLang = "<?php echo e($languageCode); ?>".toLowerCase();
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tour\resources\views\frontend\destinations\translated.blade.php ENDPATH**/ ?>