      ...
      <div class="card-body">
        <form method="POST" action="<?php echo e(route('admin.destinations.store')); ?>">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <input type="text" name="type" class="form-control" value="<?php echo e(old('type')); ?>" placeholder="national_park, beach, mountain...">
            </div>
          </div>
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <textarea name="reviews_embed" class="form-control" rows="4"
                        placeholder="Paste a review page URL, or a review widget embed code (e.g. Elfsight)"><?php echo e(old('reviews_embed')); ?></textarea>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tour\resources\views\admin\destinations\create.blade.php ENDPATH**/ ?>