<?php $__env->startSection('title', 'Edit Tour Category'); ?>
  ...
  <section class="section">
    <div class="row">
      <div class="col-lg-10">
        <div class="card">
          <div class="card-body">
            <form method="POST" action="<?php echo e(route('admin.tour-categories.update', $tourCategory)); ?>">
              <?php echo csrf_field(); ?>
              ...
              <div class="row my-3">
                ...
                <div class="col-sm-9">
                  <input type="text" name="name" class="form-control" required
                         value="<?php echo e(old('name', $tourCategory->name)); ?>">
                </div>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-9">
                  <input type="text" name="slug" class="form-control"
                         value="<?php echo e(old('slug', $tourCategory->slug)); ?>">
                  <small class="text-muted">Changing this changes the public URL (currently <code>/<?php echo e($tourCategory->slug); ?></code>) — existing links/bookmarks to the old slug will stop working.</small>
                </div>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-9">
                  <textarea name="description" class="form-control" rows="4"><?php echo e(old('description', $tourCategory->description)); ?></textarea>
                </div>
              </div>
              ...
              <div class="row mb-4">
                ...
                <div class="col-sm-9">
                  <input type="number" name="order" class="form-control w-25"
                         value="<?php echo e(old('order', $tourCategory->order)); ?>" min="0">
                </div>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-9">
                  <input type="text" name="meta_title" class="form-control"
                         value="<?php echo e(old('meta_title', $tourCategory->meta_title)); ?>"
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-9">
                  <textarea name="meta_description" class="form-control" rows="3"
                            placeholder="Discover the best Tanzania tours, safaris, and adventures..."><?php echo e(old('meta_description', $tourCategory->meta_description)); ?></textarea>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-9">
                  <input type="text" name="meta_keywords" class="form-control"
                         value="<?php echo e(old('meta_keywords', $tourCategory->meta_keywords)); ?>"
                ...
                <div class="col-sm-9">
                  <div class="form-check form-switch mt-2">
                    <input class="form-check-input" type="checkbox" name="no_robots" value="1"
                           id="no_robots" <?php echo e(old('no_robots', $tourCategory->no_robots) ? 'checked' : ''); ?>>
              ...
              <div class="row mt-5">
                ...
                <div class="col-sm-9">
                  <p class="text-muted small">
                    ...
                    (e.g. "Overview", "Why Choose <?php echo e($tourCategory->name); ?>", "Who
                  ...
                  <div id="category-sections-repeater">
                    ...
                    <?php $__currentLoopData = $existingSections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="card-body">
                          <div class="row g-3">
                            <div class="col-md-6">
                              ...
                              <input type="text" name="sections[<?php echo e($index); ?>][title]" class="form-control"
                                     value="<?php echo e(old("sections.$index.title", $section['title'] ?? '')); ?>"
                                     placeholder="e.g. Overview">
                            </div>
                            <div class="col-md-6">
                              <label class="form-label">Placement</label>
                              <?php $sectionPlacement = old("sections.$index.placement", $section['placement'] ?? 'below_grid'); ?>
                              <select name="sections[<?php echo e($index); ?>][placement]" class="form-select">
                                <option value="above_grid" <?php echo e($sectionPlacement === 'above_grid' ? 'selected' : ''); ?>>Above the tour grid</option>
                                <option value="below_grid" <?php echo e($sectionPlacement === 'below_grid' ? 'selected' : ''); ?>>Below the tour grid</option>
                              </select>
                            </div>
                            <div class="col-md-6">
                              <label class="form-label">Section Image</label>
                              <?php $sectionExistingImageId = old("sections.$index.existing_image_id", $section['existing_image_id'] ?? null); ?>
...
<?php $component = App\View\Components\MediaPicker::resolve(['name' => 'sections['.e($index).'][existing_image_id]','selected' => $sectionExistingImageId,'label' => 'Select Section Image'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                            ...
                            <div class="col-md-12">
                              ...
                              <textarea name="sections[<?php echo e($index); ?>][content]" class="form-control" rows="4"><?php echo e(old("sections.$index.content", $section['content'] ?? '')); ?></textarea>
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div id="category-section-picker-template" class="d-none">
                    <?php if (isset($component)) { $__componentOriginala26ee479c72899be3529000ab55d5999 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala26ee479c72899be3529000ab55d5999 = $attributes; } ?>
<?php $component = App\View\Components\MediaPicker::resolve(['name' => 'sections[__INDEX__][existing_image_id]','selected' => null,'label' => 'Select Section Image'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('media-picker'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\MediaPicker::class))->getConstructor()): ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tour\resources\views\admin\tour-categories\edit.blade.php ENDPATH**/ ?>